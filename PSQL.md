...
Informational
  ...
  \df[anptw][S+] [FUNCPTRN [TYPEPTRN ...]]
                         list [only agg/normal/procedure/trigger/window] functi
ons
  ...
  \dP[itn+] [PATTERN]    list [only index/table] partitioned relations [n=neste
d]
...
Connection
  \c[onnect] {[DBNAME|- USER|- HOST|- PORT|-] | conninfo}
                         connect to new database (currently "chirpy")
